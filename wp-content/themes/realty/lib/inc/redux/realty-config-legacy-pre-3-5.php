            ...
            public function setSections() {
                ...
                /* General
		            ...
		            $this->sections[] = array(
						...
						array(
		                  'id'        => 'property-search-default-address-latitude',
		                  'type'      => 'text',
		                  'title'    	=> __( 'Default Address Property Search: Latitude', 'tt' ),
		                  'subtitle'  => __( '', 'tt' ),
						...
						array(
		                  'id'        => 'property-search-default-address-longitude',
		                  'type'      => 'text',
		                  'title'    	=> __( 'Default Address Property Search: Longitude', 'tt' ),
		                  'subtitle'  => __( '', 'tt' ),
						...
						array(
			                ...
			                'type'      => 'radio',
			                'title'     => __( 'Search Relation', 'tt' ),
			                'subtitle'  => __( 'Default: AND', 'tt' ),
			                'desc'      => __( 'Select relation among search fields.', 'tt' ),
			                 //Must provide key => value pairs for radio options
			                'options'   => array(
			                	'OR' 			=> 'OR', 
			                  'AND' 		=> 'AND', 
