...
function tt_register_required_plugins() {
  ...
  $plugins = array(
    ...
    array(
		...
		array(
	    'name'                => 'Realty - Custom Post Types And Taxonomies',
	    'slug'                => 'realty-custom-post-types-and-taxonomies',
	    'source'              => get_stylesheet_directory() . '/lib/plugins/realty-custom-post-types-and-taxonomies.zip',
	    'required'            => true,
		),
		array(
	    'name'                => 'Realty - Data Migration to v2.0 (ONLY NECESSARY WHEN YOU UPDATE FROM VERSION 1.6.3 TO 2.0)',
