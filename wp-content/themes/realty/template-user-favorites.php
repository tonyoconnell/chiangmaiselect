		...
		?>
            ...
            echo '</ul></div>';
					...
					// No Favorites Saved
						...
						echo '<p class=" alert alert-info"">' . __( 'You haven\'t added any favorites.', 'tt' ) . '</p>';
					}
					
					echo '<p id="msg-no-favorites" class="hide alert alert-info">' . __( 'You haven\'t added any favorites.', 'tt' ) . '</p>';
