...
<div id="home-slideshow" class="flexslider <?php echo $realty_theme_option['home-slideshow-height-type'] . ' ' . $realty_theme_option['home-slideshow-type']; ?>">
	...
	<ul class="slides">
		...
		if ( $home_layout == "slideshow-custom" ) {
			...
			foreach ($home_slideshow as $home_slide) { 
				...
				<?php if ( $home_slide['url'] ) { echo '<a href="' . $home_slide['url'] . '" class="slideshow-content-link">'; } ?>
						...
						<div class="inner<?php if ( $custom_property_search || $mini_search ) { echo ' bottom'; } ?>">
							<div class="container">
									...
									<div class="description">
										...
										<?php //if ( $home_slide['title'] ) { echo '<div class="arrow-right"></div>'; } ?>
									</div>
									<?php } ?>
							</div>
						</div>
